...
('8','5','2013-09-03','2200','Septiembre 2013','1','1','0','El vto de Aguas Mendocinas es el 28/8/2013.
Municipalidad presentó mayo,junio,julio y agosto.
Se deja constancia que adeuda Expensas del mes de agosto, sino lo trae para octubre no se procederá al cobro','2013-09-30','0','0','0','dos mil doscientos');
INSERT INTO `charge` (`charge_id`,`contract_id`,`charge_date`,`charge_mount`,`charged_period`,`municipality`,`water_service`,`expenses`,`comment`,`expiration`,`recharge`,`deductions`,`other_recharge`,`charge_words`) VALUES
...
INSERT INTO `charge` (`charge_id`,`contract_id`,`charge_date`,`charge_mount`,`charged_period`,`municipality`,`water_service`,`expenses`,`comment`,`expiration`,`recharge`,`deductions`,`other_recharge`,`charge_words`) VALUES
('63','12','2013-10-18','1875','Octubre 2013','1','1','0','Presenta boleta de Municipalida Y Aguas Mendocina con vto.15/10/13','2013-10-31','0','0','0','MIL OCHOCIENTOS SETENTA Y CINCO');
...
('1','61280','2013-08-22','01-S. Central','01-0061280-00','Chile 750 (5500) Capital - Mendoza','hoperinverco@gmail.com','','Recibí de HUGO PERAZZO INVERSIONES (de acuerdo a la autorización de cobro de referencia) la suma de pesos {payment_words} ($ {amount} -) en concepto de pago del alquiler de {property_name} de mi propiedad, sito en calle {address} de {locality}, correspondiente al canon del mes de {period}','Recibí del Señor/a: {from}, la suma de pesos {charge_words} (${amount}-), por el alquiler de {property_name} sito/a en calle {address} de {locality} correspondiente al canon del mes de {period} que vence el {expiration}','20-08072027-1');
...
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('8','7','2013-09-06','2237','Septiembre/2013','Pago Expensas ($235.-) y presentan boletas de Municipalidad y O.S.M., ','','','9','DOS MIL DOSCIENTOS TREINTA Y SIETE');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
...
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('10','3','2013-09-11','3185','Septiembre/2013','Se retienen MIL PESOS ($1.000.-) destinados arreglos de cañerías y perdidas de agua, sujeto a renovación ','','','34','TRES MIL CIENTOS OCHENTA Y CINCO');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('11','15','2013-09-11','4872','Septiembre/2013','','','','33','CUATRO MIL OCHOCIENTOS SETENTA Y DOS');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('12','13','2013-09-11','1472','Septiembre/2013','No presenta boleta de Aguas Mendocinas, porque hizo el reclamo y no se la enviaron, la trae próximo mes','','','32','MIL CUATROCIENTOS SETENTA Y DOS');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('13','2','2013-09-11','1092','Septiembre/2013','','','','31','MIL NOVENTA Y DOS ');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('14','23','2013-09-11','3500','Septiembre/2013','','','','30','TRES MIL QUINIENTOS');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
...
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('18','21','2013-09-11','2415','Septiembre/2013','Ninguna','','','18','DOS MIL CUATROCIENTOS QUINCE');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('19','8','2013-09-11','3036','Septiembre/2013','Ninguna','','','17','TRES MIL TREINTA Y SEIS ');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('20','4','2013-09-11','1718','Septiembre/2013','Se deducen ($200.-) por pago de cochera, y ($175.-) por expensas extraordinarias','','','14','MIL SETECIENTOS DIECIOCHO ');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('21','18','2013-09-11','3104','Septiembre/2013','Paga ($600.-) de última cuota en Depósito en Garantía. correspondiente Septiembre/2013 ','','','16','TRES MIL CIENTO CUATRO');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
...
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('24','6','2013-09-11','1820','Septiembre/2013','Presenta pago Municipalidad y Aguas Mendocinas, que vence el 28/8/2013','','','36','MIL OCHOCIENTOS VEINTE');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('25','17','2013-09-12','2364','Septiembre/2013','Abona ($2040.-) correspondiente a alquiler Septiembre/2013, ($180.-) en concepto de impuestos pagos por propietaria del mes Agosto-Septiembre/2013 , mas ($360.-) en concepto de intereses por mora','0','','37','DOS MIL TRESCIENTOS SESENTA Y CUATRO');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('26','12','2013-09-16','1725','Septiembre/2013','Presento las boletas de  Municipalidad Julio, Agosto,y Septiembre/2013 y Aguas Mendocinas con Vto.13/8/2013','','','38','MIL SETECIENTOS VEINTICINCO');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
...
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('29','17','2013-10-11','1947','Octubre/2013','El alquiler corresponde a $2040.-, además abona $90.- por servicios a cargo de la propietaria del mes Octubre/2013. Total a pagar $2130.-','','90','52','MIL NOVECIENTOS CUARENTA Y SIETE');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('30','20','2013-10-11','1710','Octubre/2013','Presenta pago factura de Aguas Mendocinas con vto.26/9/2013','90','','53','MIL SETECIENTOS DIEZ');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('31','18','2013-10-11','2503','Octubre/2013','Presenta boleta Aguas Mendocinas con vto. 27/9/13','','','61','DOS MIL QUINIENTOS TRES');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('32','21','2013-10-11','2415','Octubre/2013','','','','60','DOS MIL CUATROCIENTOS QUINCE');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('33','3','2013-10-11','3185','Octubre/2013',' Presenta Impuesto Inmobiliario y carta personal','','','59','TRES MIL CIENTO OCHENTA Y CINCO');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('34','11','2013-10-11','2024','Octubre/2013','Presenta factura de Municipalidad Septiembre Octubre/2013 y Expensas','','','57','DOS MIL VEINTICUATRO');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('35','6','2013-10-11','1820','Octubre/2013','Presenta boletas de Municipalidad y expensas del mes pasado','','','56','MIL OCHOCIENTOS VEINTE');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('36','8','2013-10-11','3036','Octubre/2013','Vencimiento del agua 16/09/2013','','','55','TRES MIL TREINTA Y SEIS');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('37','13','2013-10-11','1472','Octubre/2013','Deja factura de Aguas Mendocina correspondiente al mes de Septiembre/2013, con vto.13/8/13 que había quedado pendiente, este mes no corresponde facturas','','','54','MIL CUATROCIENTOS SETENTA Y DOS');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('38','16','2013-10-11','2274','Octubre/2013','El alquiler corresponde a $2400.- ademas abona $90.- por servicios a cargo de la propietaria/octubre 2013. Total a pagar $ 2490.','','90','50','DOS MIL DOSCIENTOS SETENTA Y CUATRO');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
...
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('40','7','2013-10-11','2302','Octubre/2013','El alquiler corresponde a $2200.- mas Expensas $329.-, pero abona este mes $300, ante el desconocimiento en situación de Expensas , le comunicare en curso del mes forma de pago de la diferencia generada $940.-. Total a pagar $2500','','300','48','DOS MIL TRESCIENTOS DOS');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('41','9','2013-10-11','2484','Octubre/2013','Presenta factura de Aguas Mendocinas vto. 15/10/13 y presenta pago Expensas $336','','','46','DOS MIL CUATROCIENTOS OCHENTA Y CUATRO');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('42','5','2013-10-11','2275','Octubre/2013','','0','0','62','DOS MIL DOSCIENTOS SETENTA Y CINCO');
INSERT INTO `payment` (`payment_id`,`contract_id`,`payment_date`,`payment_mount`,`payment_period`,`comment`,`deductions`,`recharge`,`charge_id`,`payment_words`) VALUES
('43','12','2013-10-18','1725','Octubre/2013','Presenta boleta de Municipalidad Y Aguas Mendocinas con vto.15/10/13','','','63','MIL SETECIENTOS VEITICINCO');
...
INSERT INTO `person` (`person_id`,`document_type`,`document_number`,`name`,`first_surname`,`second_surname`,`street`,`street_number`,`phone`,`mobile`,`employee`,`job_adress`,`profession`,`civil_status`,`salary`,`commercial_references`,`bank_references`,`zip_code`,`bank`,`bank_number`,`bank_holder`,`bank_branch`,`locality_id`,`type`,`owner`,`cuit`) VALUES
('11','DNI','4.602.067','AIDA NELIDA','BRUNO','','B° Dalvián','Manzana 63, Casa \"11\"','4448766','155708990','0','','','single','','','','','','','','','1','owner','1','');
INSERT INTO `person` (`person_id`,`document_type`,`document_number`,`name`,`first_surname`,`second_surname`,`street`,`street_number`,`phone`,`mobile`,`employee`,`job_adress`,`profession`,`civil_status`,`salary`,`commercial_references`,`bank_references`,`zip_code`,`bank`,`bank_number`,`bank_holder`,`bank_branch`,`locality_id`,`type`,`owner`,`cuit`) VALUES
...
INSERT INTO `person` (`person_id`,`document_type`,`document_number`,`name`,`first_surname`,`second_surname`,`street`,`street_number`,`phone`,`mobile`,`employee`,`job_adress`,`profession`,`civil_status`,`salary`,`commercial_references`,`bank_references`,`zip_code`,`bank`,`bank_number`,`bank_holder`,`bank_branch`,`locality_id`,`type`,`owner`,`cuit`) VALUES
('19','DNI','23.102.988','JUAN CARLOS','LUONGO (Pinturerias Prestigio S. A.)','','Avenida Mitre','5899','5777-7550','','0','Av. del Libertador N° 850','','single','','','','','','','','','10','','0','');
INSERT INTO `person` (`person_id`,`document_type`,`document_number`,`name`,`first_surname`,`second_surname`,`street`,`street_number`,`phone`,`mobile`,`employee`,`job_adress`,`profession`,`civil_status`,`salary`,`commercial_references`,`bank_references`,`zip_code`,`bank`,`bank_number`,`bank_holder`,`bank_branch`,`locality_id`,`type`,`owner`,`cuit`) VALUES
...
INSERT INTO `person` (`person_id`,`document_type`,`document_number`,`name`,`first_surname`,`second_surname`,`street`,`street_number`,`phone`,`mobile`,`employee`,`job_adress`,`profession`,`civil_status`,`salary`,`commercial_references`,`bank_references`,`zip_code`,`bank`,`bank_number`,`bank_holder`,`bank_branch`,`locality_id`,`type`,`owner`,`cuit`) VALUES
','0','');
INSERT INTO `person` (`person_id`,`document_type`,`document_number`,`name`,`first_surname`,`second_surname`,`street`,`street_number`,`phone`,`mobile`,`employee`,`job_adress`,`profession`,`civil_status`,`salary`,`commercial_references`,`bank_references`,`zip_code`,`bank`,`bank_number`,`bank_holder`,`bank_branch`,`locality_id`,`type`,`owner`,`cuit`) VALUES
('86','DNI','26.872.093','JESICA MARÍA ','ORREGO','','JOSE INGENIEROS   ',' 623  ','','','0','','','single','','','','','','','','','16','','0','');
INSERT INTO `person` (`person_id`,`document_type`,`document_number`,`name`,`first_surname`,`second_surname`,`street`,`street_number`,`phone`,`mobile`,`employee`,`job_adress`,`profession`,`civil_status`,`salary`,`commercial_references`,`bank_references`,`zip_code`,`bank`,`bank_number`,`bank_holder`,`bank_branch`,`locality_id`,`type`,`owner`,`cuit`) VALUES
('87','DNI','24.234.903','MARCELO MARCOS ','ONTIVEROS ','','Uruguay','828','','','0','','','single','','','','','','','','','1','','0','');
...
INSERT INTO `property` (`property_id`,`street`,`street_number`,`zip_code`,`description`,`name`,`locality_id`,`designation`) VALUES
('3','Juan Díaz de Solis,','744/766, Complejo Residencial \"Selectro\"','','Living Comedor, cocina con desayunador, sector de lavandería, 2 dormitorios, baño privado en uno de sus dormitorios, ','Departamento','6','Primer Piso, Dpto. \"11\" ');
INSERT INTO `property` (`property_id`,`street`,`street_number`,`zip_code`,`description`,`name`,`locality_id`,`designation`) VALUES
...
INSERT INTO `property` (`property_id`,`street`,`street_number`,`zip_code`,`description`,`name`,`locality_id`,`designation`) VALUES
('7','Primitivo de la Reta','1016','','Salón frontal con vidrieras, baño, rejas antirrobo para las vidrieras, línea telefónica registrada ante Telefónica de Argentina S.A. y un reloj interruptor de electricidad','Un Local Comercial','1','Planta Baja, Unidad\" 5\"');
INSERT INTO `property` (`property_id`,`street`,`street_number`,`zip_code`,`description`,`name`,`locality_id`,`designation`) VALUES
...
INSERT INTO `property` (`property_id`,`street`,`street_number`,`zip_code`,`description`,`name`,`locality_id`,`designation`) VALUES
('14','Italia','477','','Porche, con ingreso a living comedor, 3 dormitorios, baño privado, comedor diario, cocina, sector de lavado, sector de servicio con baño privado y patio','Casa','1','');
INSERT INTO `property` (`property_id`,`street`,`street_number`,`zip_code`,`description`,`name`,`locality_id`,`designation`) VALUES
('15','San Patricio','182','','Living comedor, 2 dormitorios, baño completo,y alarma comunitaria con su correspondiente control','Departamento','3','Planta Baja, Unidad \"1\" B°Los Parrales');
INSERT INTO `property` (`property_id`,`street`,`street_number`,`zip_code`,`description`,`name`,`locality_id`,`designation`) VALUES
('16','San Patricio','182','','living comedor, cocina con lavandería integrada, acceso a balcón terraza de uso exclusivo, 2 dormitorios con placares, baño totalmente instalado con vanitory','Departamento','3','Planta Alta, Unidad \"4\"');
INSERT INTO `property` (`property_id`,`street`,`street_number`,`zip_code`,`description`,`name`,`locality_id`,`designation`) VALUES
('17','Los Tilos, B° Cementista II','709','','Living comedor, cocina comedor, 3 dormitorios, uno con baño privado totalmente instalado, baño completo, lavadero. cochera techada, con portón metálico, jardín y churrasquera','Casa','16','');
INSERT INTO `property` (`property_id`,`street`,`street_number`,`zip_code`,`description`,`name`,`locality_id`,`designation`) VALUES
('18','Virrey Zeballos ','149','','Living Comedor con cocina integrada, un dormitorio con placard de seis puertas, cuatro cajones, baño completo con sus artefactos ','Departamento','3','DEPARTAMENTO N° “4”, de PLANTA ALTA');
INSERT INTO `property` (`property_id`,`street`,`street_number`,`zip_code`,`description`,`name`,`locality_id`,`designation`) VALUES
('19','Maure','875','','Living, cocina comedor, 2 dormitorios y un baño completo','Un Departamento','1','Planta Baja, Unidad \"2\"');
INSERT INTO `property` (`property_id`,`street`,`street_number`,`zip_code`,`description`,`name`,`locality_id`,`designation`) VALUES
('21','Uruguay','828','','Frente: con rejas , espacio de Jardín e ingreso de vehículos; Porche con ingreso a Living-Comedor  que posee un calefactor marca ORO AZUL y un equipo de aire acondicionado  tipo Split marca PHILCO;  Escritorio  con equipo de aire acondicionado tipo Split marcas GENERAL ELECTRIC; Baño de recepción, con Vanitory; Tres(3) Dormitorios; Amplia Galería con calefactor marca EMEGE; Baño principal completo con ducha manual y  grifería completa marca FV, artefactos  marca ROCA ; Cocina-Comedor, con calefón-termo de 120 Lts; artefacto de Cocina cuatro hornallas horno y parrilla marca ESLABON DE LUJO; Mesadas en granito natural; Alacenas y Bajo-Mesadas marca JOHNSON (nuevos): Cuerpos en pared Norte y pared Oeste; sobre pared Norte: Bajo Mesada con Tres(3) cajones, uno grande y dos pequeños; y tres(3) puertas de abrir con Estante dos(2) grandes y una pequeña; sobre  pared Oeste:  Alacenas y Bajo-Mesada en juego: Alacenas cuatro (4) puertas de abrir, dos (2) con estantes, dos (2) sin estantes y Bajo','Casa','1','');
